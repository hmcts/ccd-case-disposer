...
INSERT INTO case_event (event_id, event_name, case_data_id,user_id,case_type_id,case_type_version,state_id,data,
user_first_name,user_last_name,security_classification)
VALUES ('CREATED','CREATED', (select id from case_data where reference  =1004259907353628),1,'DPR_FT_MasterCaseType',1,'CaseCreated',
    '{
      "PersonFirstName": "Janet"
    }',
    'Janet',
...
INSERT INTO case_event (event_id, event_name, case_data_id,user_id,case_type_id,case_type_version,state_id,data,
user_first_name,user_last_name,security_classification)
VALUES ('CREATED','CREATED', (select id from case_data where reference  =1004259907353629),2,'DPR_FT_MasterCaseType',2,'CaseCreated',
    '{
      "PersonFirstName": "Janet"
    }',
    'Janet',
...
INSERT INTO case_event_significant_items (description, type, url,case_event_id)
VALUES ('TEST_MEDICINE1','DOCUMENT','test url1',
(select id from case_event where case_data_id in(select id from case_data where reference  =1004259907353628)));
...
INSERT INTO case_event_significant_items (description, type, url,case_event_id)
VALUES ('TEST_MEDICINE2','DOCUMENT','test url2',
(select id from case_event where case_data_id in(select id from case_data where reference  =1004259907353629)));
