...
VALUES (1, 'FT_MultiplePages', 'BEFTA_MASTER', 'CaseCreated', 'PUBLIC',
        '{
...
INSERT INTO case_data (id, case_type_id, jurisdiction, state, security_classification, data, data_classification, reference, resolved_ttl)
VALUES (6, 'FT_MultiplePages', 'BEFTA_MASTER', 'CaseCreated', 'PUBLIC',
        '{
          "PersonFirstName": "Janet"
        }',
       '{
...
INSERT INTO case_data (id, case_type_id, jurisdiction, state, security_classification, data, data_classification, reference, resolved_ttl)
VALUES (7, 'FT_MultiplePages', 'BEFTA_MASTER', 'CaseCreated', 'PUBLIC',
        '{
          "PersonFirstName": "Janet"
        }',
       '{
...
INSERT INTO case_data (id, case_type_id, jurisdiction, state, security_classification, data, data_classification, reference, resolved_ttl)
VALUES (8, 'FT_MultiplePages', 'BEFTA_MASTER', 'CaseCreated', 'PUBLIC',
        '{
          "PersonFirstName": "Janet"
        }',
       '{
...
INSERT INTO case_data (id, case_type_id, jurisdiction, state, security_classification, data, data_classification, reference, resolved_ttl)
VALUES (10, 'FT_MultiplePages', 'BEFTA_MASTER', 'CaseCreated', 'PUBLIC',
        '{
          "PersonFirstName": "Janet"
        }',
       '{
...
VALUES (1, 'FT_MultiplePages', 7);

INSERT INTO case_link (case_id, case_type_id, linked_case_id)
VALUES (2, 'FT_MultiplePages', 8);

INSERT INTO case_link (case_id, case_type_id, linked_case_id)
VALUES (3, 'FT_MultiplePages', 9);

INSERT INTO case_link (case_id, case_type_id, linked_case_id)
VALUES (4, 'FT_MultiplePages', 10);

INSERT INTO case_link (case_id, case_type_id, linked_case_id)
VALUES (5, 'FT_MultiplePages', 11);

INSERT INTO case_link (case_id, case_type_id, linked_case_id)
VALUES (6, 'FT_MultiplePages', 12);
