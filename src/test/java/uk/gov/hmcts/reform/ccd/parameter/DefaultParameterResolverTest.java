...
public class DefaultParameterResolverTest {
    ...
    private static final String DM_REMOTE_STORE_APP_URl = "dmRemoteStoreAppUrl";
    private static final String DM_REMOTE_CASE_DOCUMENTS_DELETE_PATH = "dmRemoteCaseDocumentsDeletePath";
    ...
    public void initMock() {
        ...
        ReflectionTestUtils.setField(defaultParameterResolver,
                                     ELASTICSEARCH_HOSTS, Arrays.asList("http://localhost:9200"));
        ReflectionTestUtils.setField(defaultParameterResolver,
                                     ELASTICSEARCH_REQUEST_TIMEOUT, 6000);
        ReflectionTestUtils.setField(defaultParameterResolver,
        ...
        ReflectionTestUtils.setField(defaultParameterResolver,
                                     DM_REMOTE_STORE_APP_URl, "http://localhost:4603");
        ReflectionTestUtils.setField(defaultParameterResolver,
                                     DM_REMOTE_CASE_DOCUMENTS_DELETE_PATH, "/documents/delete");
    }
