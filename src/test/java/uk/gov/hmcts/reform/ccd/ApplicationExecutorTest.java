...
//        verify(caseDeletionService, times(1)).deleteCaseData(DELETABLE_CASE_DATA_WITH_PAST_TTL);
//        verify(caseDeletionService, times(1)).deleteCaseData(DELETABLE_CASE_DATA4_WITH_PAST_TTL);
//        verify(caseDeletionService, times(1)).deleteCaseData(DELETABLE_CASE_DATA03_WITH_PAST_TTL);
//        verify(caseDeletionResolver, times(1)).logCaseDeletion(anyList(), anyList());
//    }
//
//
...
//        when(parameterResolver.getRequestLimit()).thenReturn(3);
//
//        List<CaseData> linkedCases = List.of(
//            DELETABLE_CASE_DATA09_WITH_PAST_TTL,
...
//        applicationExecutor.execute();
//
//        // It will delete 2 root cases and 1 linked case
//        verify(caseFindingService).findCasesDueDeletion();
//        verify(caseDeletionService, times(1)).deleteCaseData(DELETABLE_CASE_DATA_WITH_PAST_TTL);
//        verify(caseDeletionService, times(1)).deleteCaseData(DELETABLE_CASE_DATA4_WITH_PAST_TTL);
//        verify(caseDeletionService, times(1)).deleteCaseData(DELETABLE_CASE_DATA09_WITH_PAST_TTL);
//        verify(caseDeletionResolver, times(1)).logCaseDeletion(anyList(), anyList());
//    }
//}
