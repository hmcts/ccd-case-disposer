...
echo "export IDAM_API_URL=https://idam-web-public.aat.platform.hmcts.net"
echo "export CCD_IDAM_REDIRECT_URL=https://ccd-case-management-web-aat.service.core-compute-aat.internal/oauth2redirect"
echo "export DEFINITION_STORE_HOST=https://ccd-definition-store-ccd-case-disposer-pr-${pr}.preview.platform.hmcts.net"
